subroutine fclaw3d_clawpatch46_fort_header_ascii (matname1, &
...
end subroutine  fclaw3d_clawpatch46_fort_header_ascii

subroutine fclaw3d_clawpatch46_fort_output_ascii(matname1, & 
    ...
    call fclaw3d_clawpatch46_fort_write_grid_header(matunit1, & 
...
end subroutine fclaw3d_clawpatch46_fort_output_ascii


subroutine fclaw3d_clawpatch46_fort_write_grid_header (matunit1, & 
    mx,my,mz, xlower,ylower, zlower, dx,dy,dz, patch_num,level, & 
     blockno,mpirank)
 ...
 1002 format(e24.16,'    xlow', /,  & 
            ...
            e24.16,'    dy',/,      & 
            e24.16,'    dz',/)
end subroutine fclaw3d_clawpatch46_fort_write_grid_header
