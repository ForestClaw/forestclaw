...
!  --------------------------------------------------------------
integer function fclaw3d_clawpatch_minmax_exceeds_th(blockno, meqn, & 
                                     qval,qmin,qmax,quad, & 
    ...
    fclaw3d_clawpatch_minmax_exceeds_th = refine

end function fclaw3d_clawpatch_minmax_exceeds_th
