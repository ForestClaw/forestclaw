...
c
c     =====================================================
      subroutine cudaclaw5_flux2(ixy,maxm,meqn,maux,mbc,mx,
...
c     # !!! Change to call cudaclaw5_limiter (original:limiter)
      if (limit) call cudaclaw5_inlinelimiter(maxm,meqn,mwaves,mbc,mx,
     &      wave,s,mthlim)
c
      do 120 i = 1, mx+1
c
