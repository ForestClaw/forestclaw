...
c    # 
c    # 1. clawpack_time_sync_store_flux (before step update)
c    # 2. clawpack_time_sync_accumulate_waves (after step update)
c    # 3. clawpack_fort_time_sync_f2c ()
c    # 4. clawpack_fort_time_sync_copy
c    # ----------------------------------------------------------------
