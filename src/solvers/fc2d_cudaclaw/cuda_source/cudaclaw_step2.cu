        ...
        int batch_size, double t, double dt)
{
    ...
    fclaw2d_timer_start_threadsafe (&glob->timers[FCLAW_TIMER_CUDA_MEMCOPY_H2H]);       
    {
    ...
    fclaw2d_timer_stop_threadsafe(&glob->timers[FCLAW_TIMER_CUDA_MEMCOPY_H2H]);       
  
    

    fclaw2d_timer_start_threadsafe(&glob->timers[FCLAW_TIMER_CUDA_MEMCOPY_H2D]);       
    {
    ...
    fclaw2d_timer_stop_threadsafe(&glob->timers[FCLAW_TIMER_CUDA_MEMCOPY_H2D]);       
    ...
    /* -------------------------- Copy q back to host ----------------------------------*/ 
    fclaw2d_timer_start_threadsafe (&glob->timers[FCLAW_TIMER_CUDA_MEMCOPY_D2H]);       
    ...
    fclaw2d_timer_stop_threadsafe (&glob->timers[FCLAW_TIMER_CUDA_MEMCOPY_D2H]);       
