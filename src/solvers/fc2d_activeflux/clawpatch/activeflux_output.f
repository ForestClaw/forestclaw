      subroutine activeflux_fort_header_ascii
     &      (matname1,matname2, time,meqn,maux,ngrids)
      ...
      mfields = meqn + 1  !! Include error, exact solution and divergence
 ...
 1000 format(e30.20,'    time', /,
     ...
     &      i5,'                 num_dim')
      ...
      subroutine activeflux_fort_write_file(matname1,
     ...
     &      q,error,soln, time, patch_num,level,blockno,mpirank)
      ...
      call activeflux_fort_write_grid_header(matunit1,
...
c     # This statement is checked above (meqn <= 5)
  120 format (5E26.16)
      ...
      subroutine activeflux_fort_write_grid_header
