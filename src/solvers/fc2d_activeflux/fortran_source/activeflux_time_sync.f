...
c    # 
c    # 1. activeflux_time_sync_store_flux (before step update)
c    # 2. activeflux_time_sync_accumulate_waves (after step update)
c    # 3. activeflux_fort_time_sync_f2c ()
c    # 4. activeflux_fort_time_sync_copy
c    # ----------------------------------------------------------------
...
c    # corrections.
c    # -----------------------------------------------------------------
      subroutine activeflux_time_sync_store_flux(mx,my,mbc,meqn,
...
c    # -----------------------------------------------------------------
      subroutine activeflux_time_sync_accumulate_waves(mx,my,
     &                                                 mbc,meqn,
     &      dt, dx,dy, patchno,
     &      el0, el1, el2, el3,
     &      fp,fm,gp,gm,
...
c    # -----------------------------------------------------------------
      ...
      subroutine activeflux_fort_time_sync_f2c (mx,my,mbc,meqn,
     &                                          idir, iface_coarse,
     &                                          coarse_blockno,
     &                                          fine_blockno,
     &                                          normal_match,
...
c    # -----------------------------------------------------------------
      subroutine activeflux_fort_time_sync_samesize(mx,my,mbc,meqn,
     &                                          idir, this_iface,
     &                                          this_blockno, 
     &                                          neighbor_blockno,
     &                                          area0, area1,
