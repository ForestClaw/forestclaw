...
c     # cases.
c     # ----------------------------------------------------------
      subroutine user_fort_interpolate_face
     &      (mx,my,mbc,meqn,
     &      qcoarse,qfine,
...
c              # ---------------------------------------------
     ...
     &                  then
      ...
      subroutine user_fort_interpolate_corner
     &      (mx,my,mbc,meqn,
     &      refratio,
...
c     # Conservative intepolation to fine grid patch
      subroutine user_fort_interpolate2fine
     &     (mx,my,mbc,meqn,
...
c     # ------------------------------------------------------
      subroutine user_fort_fixcapaq2(mx,my,mbc,meqn,
     &      qcoarse,qfine, areacoarse,areafine,igrid)
      implicit none
