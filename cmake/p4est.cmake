...
set(P4EST_CONFIGURE_ARGS -DCMAKE_INSTALL_PREFIX:PATH=${P4EST_ROOT} -Dmpi:BOOL=${mpi} -Dopenmp:BOOL=${openmp} -DSC_ROOT=${SC_ROOT})

# --- compiler flags
list(APPEND P4EST_CONFIGURE_ARGS -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_C_FLAGS=${CMAKE_C_FLAGS})
list(APPEND P4EST_CONFIGURE_ARGS -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} -DCMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS})
list(APPEND P4EST_CONFIGURE_ARGS -DCMAKE_EXE_LINKER_FLAGS=${CMAKE_EXE_LINKER_FLAGS})
...
FOREACH(CACHE_VAR ${CACHE_VARS})
  ...
  IF(CACHE_VAR_HELPSTRING STREQUAL "No help, variable specified on the command line.")
    ...
    ENDIF()
    list(APPEND P4EST_CONFIGURE_ARGS -D${CACHE_VAR}${CACHE_VAR_TYPE}=\"${${CACHE_VAR}}\")
  ENDIF()
