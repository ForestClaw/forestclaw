...
%  \\[1ex]
  \includegraphics[angle=-90,width=.75\columnwidth]{../figs_misc/advance_strong_omp}
\end{center}
...
\manyclaw set of patch-based PDE solvers.
%with
%\forestclaw.  
...
\Fig{spherical}, together with a strong scaling table from 16 to 256 MPI ranks.
