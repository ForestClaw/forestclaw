...
% either
structured
\cite{ppm, clawpack, weno, central schemes}
...
resembles \comment{is essentially?} block-structured AMR \cite{be-ol:1984, be-co:1989,
...
interpolation) have been implemented correctly.  \comment{Parallel performance results will be demonstrated in the full paper?}
...
resolution of $512 \times 512$. Figure \Fig{swirl} shows the results
...
\noindent {\bf Example 2 : } This example, we demonstrate the
