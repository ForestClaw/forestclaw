...
c                  fadd(i,m) =  fadd(i,m) + 0.5d0 * dabs(s(i,mw))
c     &             * (1.d0 - dtdxave*dabs(s(i,mw))) 
c     &              * wave(i,m,mw)*phi(i,m,mw)
c
c                  cqxx(i,m) = cqxx(i,m) + dabs(s(i,mw))
c     &             * (1.d0 - dtdxave*dabs(s(i,mw))) 
c     &              * wave(i,m,mw) *phi(i,m,mw)
c
c                  cqxx2(i,m) = cqxx2(i,m) + dabs(s(i,mw))
c     &            * (1.d0 - dabs(s(i,mw))*dtdxave) * wave(i,m,mw)
c               enddo
            enddo
         enddo         
      endif  
