...
#--------------------------
    ...
    #
    # Run file make_plots.py to create <plotdir>/_GoogleEearth.kmz
    ...
    #
    # Run make_plots.py to create <plotdir>/_GoogleEarth.kmz.  Extract frames from 
    # this file 
    # 
    ...
    # ------------------------------------------------------------
    plotfigure = plotdata.new_plotfigure(name='filament (tikz)', figno=2)
