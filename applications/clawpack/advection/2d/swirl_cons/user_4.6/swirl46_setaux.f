      subroutine swirl46_setaux(mbc,mx,my,
...
c         # Edge velocities using a streamfunction : entries (2-3)      
          call swirl46_set_edge_velocities(mx,my,mbc,dx,dy,
     &          blockno,xlower,ylower,aux,maux)
      else
c         # Center velocities : entries (2-5)      
          call swirl46_set_center_velocities(mx,my,mbc,dx,dy,
...
c           # x-face and y-face edge lengths (6,7)      
      ...
      subroutine swirl46_set_edge_velocities(mx,my,mbc,
...
c           # [x;y] = a*e1 + b*e1 = L*[a;b]            
            ...
            call swirl_edge_velocity(x1,y1,x2,y2,dy,vn)
            aux(i,j,2) = -vn
         enddo
      enddo
...
c           # y-face - left vertex
            ...
            call swirl_edge_velocity(x1,y1,x2,y2,dx,vn)
            aux(i,j,3) = vn
         enddo
      enddo
      ...
      subroutine swirl46_set_center_velocities(mx,my,mbc,
