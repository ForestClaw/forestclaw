...
c     # not be coarsened.
      ...
      call user5_get_minmax(blockno, mx,my,mbc,meqn,
     ...
     &      coarsen_threshold,tag_patch)
      ...
      subroutine user5_get_minmax(blockno, mx,my,mbc,meqn,
     ...
     &      coarsen_threshold,tag_patch)
      ...
      logical exceeds_th, fclaw2d_clawpatch_value_exceeds_th
      ...
      do i = 1,mx
         do j = 1,my
            ...
            exceeds_th = fclaw2d_clawpatch_value_exceeds_th(
