...
application=$FCLAW_APPLICATIONS_BUILD_DIR/clawpack/transport/2d/correlatedcb/correlatedcb

# change to source dir for working directory
cd $FCLAW_APPLICATIONS_SRC_DIR/clawpack/transport/2d/correlatedcb/
