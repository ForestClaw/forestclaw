...
application=$FCLAW_APPLICATIONS_BUILD_DIR/clawpack/transport/2d/slotted_disk/slotted_disk

# change to source dir for working directory
cd $FCLAW_APPLICATIONS_SRC_DIR/clawpack/transport/2d/slotted_disk/
