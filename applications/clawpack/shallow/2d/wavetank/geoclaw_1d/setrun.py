...
#------------------------------
    ...
    #------------------------------------------------------------------
    # Values set here and used below
    #------------------------------------------------------------------
    ...
    clawdata.dt_variable = not dt_fixed
    ...
    #   4 or 'mc'       ==> MC limiter
    clawdata.limiter = [limiter,limiter]
    ...
    geo_data.dry_tolerance = dry_tol
