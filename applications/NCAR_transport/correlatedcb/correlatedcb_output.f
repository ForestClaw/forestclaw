      subroutine correlatedcb_write_tfile(iframe,time,mfields,
     &      ngrids,maux)
      implicit none
 ...
 1000 format(e18.8,'    time', /,
     ...
     &      i5,'                 maux'/,/)
      ...
      subroutine correlatedcb_write_qfile(mx,my,meqn,mbc,
...
c      write(6,*) 'WARNING : (claw_out2.f ) Setting q to 0'
      do j = 1,my
         do i = 1,mx
            ...
            write(matunit1,120) (q(i,j,mq),mq=1,meqn), area(i,j)
         enddo
         write(matunit1,*) ' '
      enddo
  120 format (50E26.16)
