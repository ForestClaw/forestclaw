...
c     # compute the normals at cell edges.
      ...
      do i = -2*mbc-1,2*(mx+mbc+1)+1
         do j = -2*mbc-1,2*(my+mbc+1)+1
            ...
            call mapc2m_annulus(xc,yc,xd1,yd1,zd1)
...
c        # finest level.
     ...
     &      quadsize, quadstore,ghost_only)
      ...
      rfactor = quadsize   !! NOT the usual refinement factor;  
      dxf = dx/rfactor
      dyf = dy/rfactor
     ...
     &            ghost_only .eq. 1) then
            ...
            do ii = 0,rfactor
               do jj = 0,rfactor
                  ...
                  call mapc2m_annulus(xef,yef,xp1,yp1,zp1)
...
c     &                  blockno,xcorner,ycorner,xp1,yp1,zp1)
                  ...
                  call mapc2m_annulus(xcorner,ycorner,xp1,yp1,zp1)
