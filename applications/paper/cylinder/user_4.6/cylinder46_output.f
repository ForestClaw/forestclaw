      subroutine cylinder46_fort_header_ascii
 ...
 1000 format(e30.20,'    time', /,
     ...
     &      i5,'                 num_dim')
      ...
      subroutine cylinder46_fort_write_file(matname1,
     ...
     &      q,error,soln, time, patch_num,level,blockno,mpirank)
      ...
      double precision divu, cylinder_divergence
      ...
      call cylinder46_fort_write_grid_header(matunit1,
...
c     # This statement is checked above (meqn <= 5)
  120 format (5E26.16)
      ...
      subroutine cylinder46_fort_write_grid_header
