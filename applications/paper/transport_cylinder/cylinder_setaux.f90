...
!!    quadsize = m
    ...
    CALL fclaw2d_fort_compute_tangents(mx,my,mbc, dx,dy,&
         xd,yd,zd, level, xtangents,ytangents,edgelengths)
...
!!          # Cylinder map 
    ...
    CALL cylinder46_set_center_velocities(mx,my,mbc,dx,dy, &
...
SUBROUTINE cylinder46_set_center_velocities(mx,my,mbc, &
  ...
  DO i = 1-mbc,mx+mbc
     ...
     ENDDO
  ENDDO
END SUBROUTINE cylinder46_set_center_velocities
