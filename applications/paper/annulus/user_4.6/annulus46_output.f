      subroutine annulus46_fort_header_ascii
     &      (matname1,matname2, time,meqn,maux,ngrids)
      ...
      mfields = meqn + 3  !! Include error and exact solution
 ...
 1000 format(e30.20,'    time', /,
     ...
     &      i5,'                 num_dim')
      ...
      subroutine annulus46_fort_write_file(matname1,
     ...
     &      q,error,soln, time, patch_num,level,blockno,mpirank)
      ...
      double precision annulus_divergence, divu
      ...
      call annulus46_fort_write_grid_header(matunit1,
...
c     # This statement is checked above (meqn <= 5)
  120 format (5E26.16)
      ...
      subroutine annulus46_fort_write_grid_header
