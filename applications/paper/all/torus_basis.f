...
c     #
      ...
      call map_comp2torus_derivs(x,y,theta,phi,
...
c     # Map yc in [0,1] to phi in [-pi/2,pi/2]      
      ...
      call map_comp2torus_derivs(xc,yc,theta,phi,
     &               thetax, thetay, phix, phiy)

      end

      subroutine map_comp2torus_derivs(xc,yc,theta,phi,
     &      thetax, thetay, phix, phiy)
      implicit none
...
c     # Map yc in [0,1] to phi in [-pi/2,pi/2]      
      ...
      subroutine map_torus2comp(theta,phi,xc,yc)
      implicit none
...
c     # Map yc in [0,1] to phi in [-pi/2,pi/2]      
      ...
      subroutine map2torus(xp,yp,zp,theta,phi)
      implicit none
...
c     # [0,2*pi]      
      ...
      call map2torus(xp,yp,zp,theta,phi)

      call map_torus2comp(theta,phi,xc,yc)
