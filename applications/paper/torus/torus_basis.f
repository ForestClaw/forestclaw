...
c     # Map to computational coordinates in [0,1]x[0,1]
      subroutine map2comp(blockno,xc,yc,xp,yp,zp,xc1,yc1)
      implicit none

      double precision xc,yc,xp,yp,zp,xc1,yc1, zc1
      integer blockno
...
c     # We shouldn't be returning zc1 here - should always be zero in 2d
