...
20  if (mptr .eq. 0) go to 85
        ...
        !! Accumulate error
        CALL torus46_compute_error(blockno,mx,my,mbc,meqn, maux, mcapa, & 
...
SUBROUTINE torus46_compute_error(blockno,mx,my,mbc,meqn, maux, mcapa, & 
...
END SUBROUTINE torus46_compute_error
