DOUBLE PRECISION function allencahn_qexact(x,y)
    IMPLICIT NONE
    ...
    call allencahn_qexact_complete(x,y,q,qlap,grad,flag)

    allencahn_qexact = q

end function allencahn_qexact

DOUBLE PRECISION function allencahn_qexact_rhs(x,y)
    implicit none
    ...
    CALL allencahn_fort_beta(x,y,b,grad_beta)

    flag = 2
    CALL allencahn_qexact_complete(x,y,q,qlap,grad_q,flag)

    allencahn_qexact_rhs = grad_beta(1)*grad_q(1) +  grad_beta(2)*grad_q(2) + b*qlap

END FUNCTION allencahn_qexact_rhs



SUBROUTINE allencahn_qexact_gradient(x,y,q,grad)
    IMPLICIT NONE
...
END SUBROUTINE allencahn_qexact_gradient



SUBROUTINE allencahn_qexact_complete(x,y,q,qlap,grad,flag)
...
end subroutine allencahn_qexact_complete
...
subroutine allencahn_fort_beta(x,y,b,grad)
    implicit none
...
end subroutine allencahn_fort_beta
