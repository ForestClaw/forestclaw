subroutine phasefield_fort_header_ascii(matname1,matname2, time,meqn,maux,ngrids)
    implicit none
...
end subroutine phasefield_fort_header_ascii

subroutine phasefield_fort_output_ascii(matname1, & 
...
end subroutine phasefield_fort_output_ascii
