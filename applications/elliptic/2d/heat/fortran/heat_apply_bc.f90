...
subroutine heat_fort_apply_bc(blockno, mx, my,mbc,mfields,xlower,ylower, &
        ...
        do iface = 0,3
            if (intersects_bc(iface) .ne. 0) then
                ...
                elseif (bctype(iface) .eq. 2) then
                    ...
                    write(6,*) 'heat_apply_bc : Invalid bctype'
                    stop
                endif
                ...
                d = (a/2.d0 + b/h)  
                if (d .eq. 0) then
                    write(6,*) 'heat_fort_apply_bc : ill-defined BCs'
                    stop
                endif
                ...
                if (idir .eq. 0) then
                    ...
                    elseif (iface .eq. 1) then
                        ...
                        write(6,*) 'heat_apply_bc : ic, i1, or ig not initialized'
                        stop
                    endif
                ...
                elseif (idir .eq. 1) then
                    ...
                    elseif (iface .eq. 3) then
                        ...
                        write(6,*) 'heat_apply_bc : jc, j1, or jg not initialized'
                        stop
                    endif
                    !! location at interface
                    y = ylower + (j1 - 1)*dy
...
end subroutine heat_fort_apply_bc
