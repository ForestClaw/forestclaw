        ...
        do iface = 0,3
            if (intersects_bc(iface) .ne. 0) then
                ...
                elseif (bctype(iface) .eq. 2) then
                    ...
                    write(6,*) 'poisson_apply_bc : Invalid bctype choice'
                    stop
                endif
                ...
                if (idir .eq. 0) then
                    ...
                    elseif (iface .eq. 1) then
                        ...
                        write(6,*) 'poisson_apply_bc : ic, i1, or ig not initialized'
                        stop
                    endif
                ...
                elseif (idir .eq. 1) then
                    ...
                    elseif (iface .eq. 3) then
                        ...
                        write(6,*) 'poisson_apply_bc : jc, j1, or jg not initialized'
                        stop
                    endif
                    !! location at interface
                    y = ylower + (j1 - 1)*dy
