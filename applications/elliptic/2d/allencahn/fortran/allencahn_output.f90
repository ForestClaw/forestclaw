subroutine allencahn_fort_header_ascii(matname1,matname2, time,meqn,maux,ngrids)
    implicit none
...
end subroutine allencahn_fort_header_ascii

subroutine allencahn_fort_output_ascii(matname1, & 
...
end subroutine allencahn_fort_output_ascii
