double precision function mgtest_fort_eval_bc(iface,t,x,y)
    implicit none
    ...
    call mgtest_qexact_gradient(x,y,q,grad)
    ...
    mgtest_fort_eval_bc = a*q + b*qn

    return
    
end function mgtest_fort_eval_bc